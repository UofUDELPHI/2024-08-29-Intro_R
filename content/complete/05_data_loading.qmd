...
We could define a vector for each variable in our data
...
We could alternatively define a single data frame object that contained each vector
...
CSV files are one of the *simplest* data formats. Whenever possible, try to obtain tabular data in a CSV format.
